...
export const PricingSection = () => (
  <section
    id={c.pricing.id}
    className='bg-mist-950 flex flex-col gap-4 py-12 px-4 text-mist-400 font-sans items-center'
  >
      ...
      <div className='flex items-center gap-4 flex-col w-full'>
        ...
        <div className='flex items-center gap-2 justify-center w-full'>
          ...
          <p className='flex flex-col text-right text-xs'>
            <span className=''>{c.pricing.price.multiplier}</span>
            <span className=''>{c.pricing.price.currency}</span>
          </p>
        </div>

        <p className='text-xs'>
          <span className=''>{c.pricing.price.future_label}: </span>
          <strong className='text-amber-400'>{c.pricing.price.future} </strong>
          <span className=''>{c.pricing.price.multiplier} </span>
          <span className=''>{c.pricing.price.currency}</span>
        </p>
      </div>
